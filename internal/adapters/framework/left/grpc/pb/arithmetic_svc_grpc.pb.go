...
type ArithmeticServiceClient interface {
	GetSum(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*Result, error)
	GetSub(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*Result, error)
	GetMul(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*Result, error)
	GetDiv(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *arithmeticServiceClient) GetSum(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/pb.ArithmeticService/GetSum", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *arithmeticServiceClient) GetSub(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (c *arithmeticServiceClient) GetMul(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (c *arithmeticServiceClient) GetDiv(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
type ArithmeticServiceServer interface {
	GetSum(context.Context, *OperationParameters) (*Result, error)
	GetSub(context.Context, *OperationParameters) (*Result, error)
	GetMul(context.Context, *OperationParameters) (*Result, error)
	GetDiv(context.Context, *OperationParameters) (*Result, error)
}
...
func (UnimplementedArithmeticServiceServer) GetSum(context.Context, *OperationParameters) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSum not implemented")
}
func (UnimplementedArithmeticServiceServer) GetSub(context.Context, *OperationParameters) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSub not implemented")
}
func (UnimplementedArithmeticServiceServer) GetMul(context.Context, *OperationParameters) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMul not implemented")
}
func (UnimplementedArithmeticServiceServer) GetDiv(context.Context, *OperationParameters) (*Result, error) {
...
func _ArithmeticService_GetSum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OperationParameters)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArithmeticServiceServer).GetSum(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ArithmeticService/GetSum",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetSum(ctx, req.(*OperationParameters))
	}
...
func _ArithmeticService_GetMul_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetMul(ctx, req.(*OperationParameters))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArithmeticService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetSum",
			Handler:    _ArithmeticService_GetSum_Handler,
		},
		{
			MethodName: "GetSub",
